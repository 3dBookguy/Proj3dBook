...
namespace Win
{
    ...
    public:
        ...
        virtual int command(int id, int cmd, LPARAM msg, HWND handle);       // for WM_COMMAND: id, cmd, msg
        virtual int contextMenu(HWND handle, int x, int y);     // for WM_CONTEXTMENU: handle, x, y
        virtual int create(HWND handle);                                   // for WM_CREATE
    ...
    inline int Controller::command(int id, int cmd, LPARAM msg, HWND handle) { return 0; }
    inline int Controller::contextMenu(HWND handle, int x, int y) { return 0; }
    inline int Controller::create(HWND handle) { return 0; }
